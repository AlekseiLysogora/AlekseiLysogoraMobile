...
public class AssertDataProvider {
    ...
    public String expectedHomePageTitle = getTestDataProperty
            .getResource("expectedHomePageTitle");
    public String expectedRegistrationPage = getTestDataProperty
            .getResource("expectedHomePageTitle");
    public String expectedBudgetPage = getTestDataProperty
            .getResource("expectedHomePageTitle");

    public String newEmail = randomInt + getTestDataProperty
            .getResource("newEmail");
    public String newUsername = randomInt + getTestDataProperty
            .getResource("newUsername");
    //password length should be between 8 and 20 symbols
    public String newPassword = randomInt + getTestDataProperty
